...
export default function PricingTable() {
  ...
  return (
    <div>
      ...
      <LandingNavBar />
      {/* TITLE */}
      <h1 className="mb-[30px] font-[40px]">Pricing</h1>
      {/* PRICING */}
      <div className="mx-auto max-w-screen-xl h-screen">
        {/* Pricing toggle */}
        <div className="flex justify-center max-w-[14rem] m-auto mb-[20px]">
        ...
        <div className="max-w-sm mx-auto grid gap-6 lg:grid-cols-3 items-start lg:max-w-none">
          ...
          <PricingTab
            yearly={isAnnual}
            planName="Private Beta (Requires Code)"
            price={{ yearly: 0, monthly: 0 }}
            planDescription="You know who you are!"
            features={[
              "One Book",
          ...
          <PricingTab
            ...
            planDescription="Full service chatbot generation (prices subject to change)"
            features={["One Book", "Three Characters", "Limited reader access"]}
          />
          ...
          <PricingTab
            ...
            planDescription="Boundless possibiltiy with character interation (prices subject to change)"
            features={[
              "Unlimited books",
              "Unlimited characters",
              "Unlimited reader access",
              "Generated character headshots",
            ]}
          />
        </div>
      </div>
